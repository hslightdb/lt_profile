...
BEGIN
    ...
    CASE (
      ...
      ELSE
        RAISE 'Unsupported lt_stat_statements extension version.';
    ...
    -- Sample data from lt_stat_statements and pg_stat_kcache top whole cluster statements
    FOR qres IN
        SELECT
          -- lt_stat_statements fields
          sserver_id,
          s_id AS sample_id,
    ...
    CASE (
      ...
      ELSE
        RAISE 'Unsupported lt_stat_statements version. Supported versions are 1.3, 1.4, 1.5, 1.6, 1.7, 1.8';
    END CASE;
    ...
    CASE (
      ...
      ELSE
        RAISE 'Unsupported lt_stat_statements version. Supported versions are 1.3 - 1.8';
    END CASE;
END;
$$ LANGUAGE plpgsql;